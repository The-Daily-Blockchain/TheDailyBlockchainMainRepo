        ...
        <div>
          <div className="grid grid-cols-2">
            ...
            <div className="mt-28 w-3/5 mx-4">
              ...
              With a small team of like-minded individuals, The founders founded
              a company called The Daily Blockchain PH. Their mission was to
              provide news and updates about the latest developments in the
              world of blockchain, cryptocurrency, and decentralized finance.
              They aimed to be the go-to source of information for individuals
              and businesses who wanted to stay ahead of the game.
            </div>
          </div>
          <div className="mx-44 mb-12 mt-6 text-center">
            ...
            <div className="text-start md:w-6/12 mx-auto">
              ...
              excellence. We also recognize the importance of education in this
              rapidly evolving field, and we strive to provide in-depth
